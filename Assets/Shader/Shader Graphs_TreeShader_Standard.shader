Shader "Shader Graphs/TreeShader_Standard" {
	Properties {
		[NoScaleOffset] _LushMap ("LushMap", 2D) = "white" {}
		_AltitudeRange ("AltitudeRange", Vector) = (0,0,0,0)
		_AltIntensity ("AltIntensity", Float) = 0
		_LushIntensity ("LushIntensity", Float) = 0
		_LargeNoiseScale ("LargeNoiseScale", Float) = 0
		_NoiseSmallScale ("NoiseSmallScale", Float) = 0
